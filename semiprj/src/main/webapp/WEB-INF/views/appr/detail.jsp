...
<div style="padding:30px;">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
        <h2 style="margin:0; font-size:22px; font-weight:700; color:var(--main-color);">📄 결재 문서 상세</h2>
        <button onclick="location.href='/appr/list'"
    ...
    <div style="background:white; border-radius:10px;
        ...
        <h3 style="margin:0 0 16px 0; font-size:15px; color:var(--main-color); font-weight:600;">문서 정보</h3>
        <table style="width:100%; border-collapse:collapse; font-size:14px;">
            <tr style="border-bottom:1px solid #f0f0f0;">
                <th style="padding:12px 16px; text-align:left; color:#888;
                           font-weight:600; width:120px; background:#fafafa;">문서종류</th>
                <td style="padding:12px 16px;">${appDto.appType}</td>
                <th style="padding:12px 16px; text-align:left; color:#888;
                           font-weight:600; width:120px; background:#fafafa;">진행상황</th>
            ...
            <tr style="border-bottom:1px solid #f0f0f0;">
                <th style="padding:12px 16px; text-align:left; color:#888;
                           font-weight:600; background:#fafafa;">문서명</th>
                <td style="padding:12px 16px;" colspan="3">${appDto.appTitle}</td>
            </tr>
            <tr style="border-bottom:1px solid #f0f0f0;">
                <th style="padding:12px 16px; text-align:left; color:#888;
                           font-weight:600; background:#fafafa;">기안자</th>
                <td style="padding:12px 16px;">${appDto.empName}</td>
                <th style="padding:12px 16px; text-align:left; color:#888;
                           font-weight:600; background:#fafafa;">기안일</th>
                <td style="padding:12px 16px;">${appDto.appDate}</td>
            </tr>
            <tr>
                <th style="padding:12px 16px; text-align:left; color:#888;
                           font-weight:600; background:#fafafa;">내용</th>
    ...
    <c:if test="${not empty vacAppDto}">
        <div style="background:white; border-radius:10px;
                    box-shadow:0 1px 4px rgba(0,0,0,0.08); padding:24px; margin-bottom:16px;">
            <h3 style="margin:0 0 16px 0; font-size:15px; color:var(--main-color); font-weight:600;">휴가 정보</h3>
            <table style="width:100%; border-collapse:collapse; font-size:14px;">
                <tr>
                    <th style="padding:12px 16px; text-align:left; color:#888;
    ...
    <c:if test="${not empty expAppDto}">
        <div style="background:white; border-radius:10px;
                    box-shadow:0 1px 4px rgba(0,0,0,0.08); padding:24px; margin-bottom:16px;">
            <h3 style="margin:0 0 16px 0; font-size:15px; color:var(--main-color); font-weight:600;">품의 정보</h3>
            <table style="width:100%; border-collapse:collapse; font-size:14px;">
                <tr style="border-bottom:1px solid #f0f0f0;">
                    <th style="padding:12px 16px; text-align:left; color:#888;
    ...
    <c:if test="${not empty dftAppDto}">
        <div style="background:white; border-radius:10px;
                    box-shadow:0 1px 4px rgba(0,0,0,0.08); padding:24px; margin-bottom:16px;">
            <h3 style="margin:0 0 16px 0; font-size:15px; color:var(--main-color); font-weight:600;">업무기안 정보</h3>
            <table style="width:100%; border-collapse:collapse; font-size:14px;">
                <tr>
                    <th style="padding:12px 16px; text-align:left; color:#888;
    ...
    <div style="background:white; border-radius:10px;
                box-shadow:0 1px 4px rgba(0,0,0,0.08); padding:24px; margin-bottom:16px;">
        <h3 style="margin:0 0 16px 0; font-size:15px; color:var(--main-color); font-weight:600;">결재선</h3>
        <table style="width:100%; border-collapse:collapse; font-size:14px;">
            <thead>
                <tr style="border-bottom:2px solid var(--main-color);">
                    <th style="padding:12px 16px; text-align:left; color:var(--main-color); font-weight:600;">순서</th>
                    <th style="padding:12px 16px; text-align:left; color:var(--main-color); font-weight:600;">결재자</th>
                    <th style="padding:12px 16px; text-align:left; color:var(--main-color); font-weight:600;">부서</th>
                    <th style="padding:12px 16px; text-align:left; color:var(--main-color); font-weight:600;">직급</th>
                    <th style="padding:12px 16px; text-align:center; color:var(--main-color); font-weight:600;">상태</th>
                    <th style="padding:12px 16px; text-align:left; color:var(--main-color); font-weight:600;">결재일</th>
                    <th style="padding:12px 16px; text-align:left; color:var(--main-color); font-weight:600;">반려사유</th>
                </tr>
            </thead>
            <tbody>
    ...
    <c:if test="${myTurn != null}">
        <div style="display:flex; gap:12px; justify-content:center; margin-top:24px;">
            <form action="/appr/approve" method="post"
                ...
                <button type="submit"
                        style="padding:12px 28px; background:var(--main-color); color:white;
                               border:none; border-radius:8px; font-size:14px;
                               font-weight:600; cursor:pointer;">
                    ✅ 승인
                </button>
            </form>
            <button type="button" onclick="openRejectPopup()"
                    style="padding:12px 28px; background:#ffebee; color:#c62828;
                           border:1px solid #c62828; border-radius:8px; font-size:14px;
                           font-weight:600; cursor:pointer;">
                ❌ 반려
            </button>
        </div>
...
<div id="rejectPopup" style="display:none; position:fixed; top:0; left:0;
    ...
    <div style="background:white; padding:30px; border-radius:12px; width:440px;
                box-shadow:0 4px 20px rgba(0,0,0,0.15);">
        <h3 style="margin:0 0 16px 0; color:var(--main-color);">반려 사유</h3>
        <form action="/appr/reject" method="post" onsubmit="return validateReject()">
            <input type="hidden" name="appLineId" value="${myTurn.appLineId}">
            <input type="hidden" name="appId" value="${appDto.appId}">
            <textarea id="rejectReason" name="appLineRej"
            ...
            <div style="display:flex; gap:8px; justify-content:center; margin-top:16px;">
                <button type="submit"
                        style="padding:10px 24px; background:#ffebee; color:#c62828;
                               border:1px solid #c62828; border-radius:6px;
                               font-size:14px; font-weight:600; cursor:pointer;">
                    반려 확정
                </button>
                <button type="button" onclick="closeRejectPopup()"
                        style="padding:10px 24px; background:#f0f0f0; color:#333;
