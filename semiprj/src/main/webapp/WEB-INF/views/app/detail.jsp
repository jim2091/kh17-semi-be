...
<div style="padding:30px;">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
        <h2 style="margin:0; font-size:22px; font-weight:700; color:var(--main-color);">📄 결재문서 상세</h2>
        ...
        <table style="width:100%; border-collapse:collapse; font-size:14px;">
            <thead>
                <tr style="background:#f8f9fa; border-bottom:1px solid #eee;">
                    <th style="padding:12px 16px; text-align:left; color:#555; font-weight:600;">순서</th>
                    <th style="padding:12px 16px; text-align:left; color:#555; font-weight:600;">결재자</th>
                    <th style="padding:12px 16px; text-align:left; color:#555; font-weight:600;">부서</th>
                    <th style="padding:12px 16px; text-align:left; color:#555; font-weight:600;">직급</th>
                    <th style="padding:12px 16px; text-align:center; color:#555; font-weight:600;">상태</th>
                    <th style="padding:12px 16px; text-align:left; color:#555; font-weight:600;">결재일</th>
                    <th style="padding:12px 16px; text-align:left; color:#555; font-weight:600;">반려사유</th>
                </tr>
            </thead>
            <tbody>
