...
<div style="padding: 30px;">
	<%-- 탭 네비게이션 --%>
	<div
		style="display: flex; gap: 0; margin-bottom: 24px; border-bottom: 2px solid var(--main-color);">
		<a href="/app/list"
			style="padding: 12px 28px; text-decoration: none; font-size: 14px; font-weight: 600; background: var(--main-color); color: white; border-radius: 8px 8px 0 0;">
			기안 문서함 </a> <a href="/appr/list"
			style="padding: 12px 28px; text-decoration: none; font-size: 14px; font-weight: 600; background: #f8f9fa; color: #888; border-radius: 8px 8px 0 0;">
			결재 문서함 </a>
	</div>
	...
	<div style="display: flex; gap: 8px;">
		<a href="./vacInsert"
			style="padding: 8px 16px; background: var(--main-color); color: white; border-radius: 6px; text-decoration: none; font-size: 13px;">
			+ 휴가신청서 </a> <a href="./expInsert"
			style="padding: 8px 16px; background: var(--main-color); color: white; border-radius: 6px; text-decoration: none; font-size: 13px;">
			+ 품의서 </a> <a href="./dftInsert"
			style="padding: 8px 16px; background: var(--main-color); color: white; border-radius: 6px; text-decoration: none; font-size: 13px;">
			+ 업무기안서 </a>
	</div>
</div>
